...
$query="SELECT centerlised_table.stud_individual_id,centerlised_table.name,centerlised_table.college,centerlised_table.year FROM `centerlised_table` left join `technical_connection`on (centerlised_table.`technical_connection`='*'&& `technical_connection`.`completed`='*')&&(centerlised_table.`stud_individual_id`= `technical_connection`.`stud_individual_id`) where `technical_connection`.stud_individual_id is null &&  centerlised_table.`technical_connection`='*';";
            ...
            <table class="table1">
                <thead>
                    <tr>
                        ...
                        <th scope="col" abbr="Business">College</th>
                        <th scope="col" abbr="Deluxe">Year</th>
                    </tr>
                </thead
                <tbody>
                <?php
                    ...
                    $query_1="select stud_individual_id from technical_connection where completed='*';";
                    ...
                    while ($j_1<$i_1) {
                    echo "<tr>";
                        echo "<td>$stud_individual_id_1[$j_1]</td>";
                        echo "<td>$name_1[$j_1]</td>";
                        echo "<td>$college_1[$j_1]</td>";
                        echo "<td>$year_1[$j_1]</td>";
                    echo "</tr>";
                    $j_1++;
                }
                ?>
        ...
        <div id="content">
            <table class="table1">
                ...
                <?php
                   while ($j<$i) {
                    echo "<tr>";
                        echo "<td>$stud_individual_id[$j]</td>";
                        echo "<td>$name[$j]</td>";

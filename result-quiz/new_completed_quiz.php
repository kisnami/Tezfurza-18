...
$query="SELECT centerlised_table.stud_individual_id,centerlised_table.name,centerlised_table.college,centerlised_table.year FROM `centerlised_table` left join `technical_quiz`on (centerlised_table.`technical_quiz`='*'&& `technical_quiz`.`completed`='*')&&(centerlised_table.`stud_individual_id`= `technical_quiz`.`stud_individual_id`) where `technical_quiz`.stud_individual_id is null &&  centerlised_table.`technical_quiz`='*';";
    ...
    <center><h2>Event Completed</h2></center>
        <div id="content">
            <table class="table1">
                ...
                $query_1="select stud_individual_id from technical_quiz where completed='*';";

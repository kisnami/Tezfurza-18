...
<h2><center>Result Quiz</center></h2>
...
$queer="select * from technical_quiz where completed='*' order by earned_mark desc limit 5;";
$truncate="truncate table result_table_technical_quiz;";
...
$i=0;
while ($i<5) {
	$qr="insert into result_table_technical_quiz values('','$stud_individual_id[$i]','$name[$i]','$year[$i]','$department[$i]','$college[$i]')";
	...
	$tableQuery="select * from result_table_technical_quiz;";
